    ...
    <div class="middle-box">
      <div>
        ...
        <div class="step well">
          ...
          <form method="POST" action="{{ route('employee_resume.build.education.store') }}">
            @csrf
            ...
            <div class="row">
              ...
              <div class="col-md-6  mb-3">
                ...
                <input id="field_study" type="text" class="form-control" name="field_study" value="{{ old('field_study') }}" required>
            ...
            <div class="text-center">
              ...
              @else
                ...
                <a href="{{route('employee_resume.build.work_history')}}" class="action back btn btn-info mt-3" style="font-size: 12px;">{{ __('Back') }}</a>
              @endif
            </div>
          </form>
        </div>
