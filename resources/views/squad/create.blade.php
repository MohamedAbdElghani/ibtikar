                  ...
                  <div class="stepForm">
                      ...
                      <div class="form-check">
                          <input class="form-check-input" type="radio" name="project_service"
                              id="project_service_desc1" value="{{ __('squad.food_delivery') }}" checked="checked">
                      ...
                      <div class="form-group ">
                          <textarea class="form-control" name="project_service_desc" maxlength="250"
                              rows="3" placeholder="{{ __('squad.add_your') }}"></textarea>
                      </div>

                        <div class="form-group ">
                            <label for="app_liked">{{ __('squad.more_info') }}</label>
                            <textarea class="form-control" name="app_liked" maxlength="250"
                                rows="3" placeholder="{{ __('squad.links_to_apps') }}"></textarea>
                        </div>
                  </div>
              </div>
              ...
              <div class="row fieldsetrow">
                  <div class="col-md-9">
                      <div class="stepForm">
                          ...
                          <div class="form-group ">
                              <input type="hidden" name="project_technology" />
                          ...
                          <div class="unselectedItems mt-5">
                              ...
                              <ul id="most_used">
                                  <li><i data-feather="plus"></i>Node.js</li>
                                  <li><i data-feather="plus"></i>Angular</li>
                                  <li><i data-feather="plus"></i>iOS</li>
                                  <li><i data-feather="plus"></i>Android</li>
                                  <li><i data-feather="plus"></i>React</li>
                                  <li><i data-feather="plus"></i>PHP</li>
                                  <li><i data-feather="plus"></i>Ruby on Rails</li>
                                  <li><i data-feather="plus"></i>Python</li>
                                  <li><i data-feather="plus"></i>Java</li>
                                  <li><i data-feather="plus"></i>React Native</li>
                                  <li><i data-feather="plus"></i>UI/UX Design</li>
                                  <li><i data-feather="plus"></i>Scala</li>
                                  <li><i data-feather="plus"></i>C#</li>
                                  <li><i data-feather="plus"></i>C++</li>
                                  <li><i data-feather="plus"></i>Server Hosting</li>
                              </ul>
                          </div><!-- selectedItems end -->
                      ...
                      <div class="stepForm">
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="squad_size"
                                  id="squad_size1" value="3 - 5" checked>
                      ...
                      <div class="stepForm">
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="project_status"
                                  id="project_status1" value="{{ __('squad.i_will_process') }}" checked>
                          ...
                          <div class="form-group ">
                              <textarea class="form-control" name="project_status_desc" maxlength="250"
                                  rows="3" placeholder="{{ __('squad.define_your') }}"></textarea>
                          </div>
